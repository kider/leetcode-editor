...
public class ArticleManager {
    ...
    public static void openArticle(Question question, Project project) {
        ...
        String filePath = PersistentConfig.getInstance().getTempFilePath() + question.getArticleSlug() + ".md";
    ...
    public static String formatMarkdown(String content, Project project) {
        ...
        while (latexMatcher.find()) {
            ...
            if (group.contains("\\")) {
                ...
                String filePath = PersistentConfig.getInstance().getTempFilePath() + fileName;
                File file = new File(filePath);
                if (!file.exists()) {
