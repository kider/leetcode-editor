...
public class SettingUI {
    ...
    public void initUI() {
        ...
        packagePathField.addBrowseFolderListener(new TextBrowseFolderListener(FileChooserDescriptorFactory.createSingleFileOrFolderDescriptor()) {
        });
    ...
    private void loadSetting() {
        ...
        if (config != null) {
            ...
            if (StringUtils.isNotBlank(config.getPackagePath())) {
                packagePathField.setText(config.getPackagePath());
            }
    ...
    public void apply() {
        ...
        process(config);
        File file = new File(config.getFilePath() + File.separator);
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public void process(Config config) {
        ...
        config.setPackagePath(packagePathField.getText());
